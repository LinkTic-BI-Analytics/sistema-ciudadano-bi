...
| T024 | La pantalla «Cuéntanos qué pasa», con los tokens y el selector escribir/hablar | RF1, RF2, N02 | T023, T026 | A | orquestador | terminado | **16 recorridos en navegador**, escritorio y teléfono · **sin validar con personas: `/validar` no se ha corrido** |
| T025 | Síntesis corregible y confirmada por la persona, versionada | RF2, N03, V14 | T024 | A | orquestador | terminado | 7 casos + 2 recorridos · confirmar **no** mueve `estado_revision`, comprobado · las dos clases de corrección quedan distinguidas para `Q15` |
| T034 | La ruta de alerta urgente: se abre desde un aporte, sin esperar expediente | RF1, I1, I2 | T023, T024 | A | orquestador | terminado | `V13` completo menos el directorio territorial (`Q13`): los tres estados separados, y la IA no puede impedir ni desactivar |
| T035 | Prioridad de examen con motivo, y los cinco factores **por separado** | RF12, PRI-01, I5, N08 | T028 | B | orquestador | terminado | sin columna de puntaje ni de posición, y probado en `/consola`: `construccion/progreso/T035-registro.md` |
| T036 | La bandeja de lo poco recurrente sin revisar | RF12, PRI-01, BI-02, N08 | T035 | B | orquestador | candidato | una necesidad con un aporte es tan encontrable como una con miles |
| T037 | Afinar la captura en **dos vueltas después de recibir**, y las etiquetas de la consola | RF1, N02, N03, V14, IA-01 | T025 | A | orquestador | terminado | el comprobante sale antes de afinar y afinar se puede abandonar: `construccion/progreso/T037-registro.md` |
| T038 | El corte de la captura apoyado por Mistral, **con guardián** | RF1, N03, IA-01, INT-01 | T037 | A | orquestador | terminado | la IA recorta, no redacta: lo que no está anclado en el relato se descarta — `construccion/progreso/T038-registro.md` |
| T039 | La captura como conversación: se pregunta **solo por lo que falta** | RF1, N02, N03, IA-01, PRI-01, ADR 0012 | T038 | A | orquestador | terminado | el botón ya no dice «enviar» y nada se pide dos veces: `construccion/progreso/T039-registro.md` |
| T040 | El municipio se lo confirma **la persona**, con DIVIPOLA | RF1, GEO-01, I2, ADR 0012 | T039 | A | orquestador | terminado | «rionegro antioquia» llega a la bandeja ya ubicado: `construccion/progreso/T040-registro.md` |
| T041 | El formulario **insiste** hasta llegar a un municipio | RF1, GEO-01, I2, N02 | T040 | A | orquestador | terminado | «en mi casa» ya no pasa de largo, y los 122 municipios invisibles aparecen: `construccion/progreso/T041-registro.md` |
| T042 | El lugar de lo macro a lo micro, y **quién habla** | RF1, GEO-01, V19, Q23 | T041 | A | orquestador | terminado | departamento → municipio, y la vocería que nunca se capturaba: `construccion/progreso/T042-registro.md` |
| T043 | Escoger el municipio **se puede deshacer**, y con buscador | RF1, GEO-01, I2 | T042 | A | orquestador | terminado | 125 en una lista no se recorren, y un toque ya no era irreversible: `construccion/progreso/T043-registro.md` |
| T044 | **Un problema a la vez**, y un proveedor falso para poder probarlo | RF1, N03, R1, IA-01 | T043 | A | orquestador | terminado | tres necesidades en un aporte no se pueden atender: `construccion/progreso/T044-registro.md` |
| T045 | El contexto del primer problema **se ofrece** en el segundo | RF1, GEO-01, I2, N02 | T044 | A | orquestador | terminado | volver a preguntarlo todo es lo que hace abandonar en el segundo: `construccion/progreso/T045-registro.md` |
| T046 | La portada con convocatoria y agenda | RF10, AGE-01, M06 | T045 | A | orquestador | terminado | «próximos encuentros en portada» y la convocatoria cerrada que no promete: `construccion/progreso/T046-registro.md` |
| T047 | Contar hablando: **el audio es el original** | RF1, RF2, N03, IA-01, ADR 0013 | T046 | A | orquestador | terminado | la grabación se guarda antes que el aporte y la base lo exige: `construccion/progreso/T047-registro.md` |
| T048 | Crear encuentros y sus **QR por pieza**, y confirmar el contexto al entrar | RF10, QR-01, QR-02, QR-03, QR-04 | T047 | A | orquestador | terminado | tres contextos que no se confunden: `construccion/progreso/T048-registro.md` |
| T049 | La **pieza gráfica** sale del registro, no de una copia a mano | PIE-01, PIE-02, PIE-03, PIE-04 | T048 | A | orquestador | terminado | requisito escrito primero, y cuatro formatos con QR dentro: `construccion/progreso/T049-registro.md` |
| T050 | La bandeja dice **qué falta y qué señales trae** cada aporte | RF2, BI-02, backoffice-especificacion | T049 | A | orquestador | terminado | de tres datos a lo que hace falta para decidir: `construccion/progreso/T050-registro.md` |
| T051 | Lo que se guarda **se ve**: en la ficha y en «mis aportes» | RF2, QR-03, ADR 0013, N16 | T050 | A | orquestador | terminado | de diez cosas capturadas se mostraban cinco: `construccion/progreso/T051-registro.md` |
| T052 | El municipio **siempre se pregunta**, y una vuelta no borra la anterior | RF1, GEO-01, I2, N02, N03 | T051 | A | orquestador | terminado | tres defectos que se vieron en pantalla y no en el código: `construccion/progreso/T052-registro.md` |
| T053 | La bandeja **dice cuántos hay**, y deja ver lo recién llegado | RF2, BI-02, backoffice-especificacion | T052 | A | orquestador | terminado | diez aportes eran invisibles y nada lo decía: `construccion/progreso/T053-registro.md` |
| T054 | **Tema, recurrencia y gestión medio llena**: lo que hacía falta para clasificar | CLA-01, CLA-02, CLA-03, CLA-04 | T053 | A | orquestador | terminado | faltaba el eje, no más texto: `construccion/progreso/T054-registro.md` |
| T055 | Lo que se detecta del lugar **no se tira**: llega puesto al selector | RF1, GEO-01, I2 | T054 | A | orquestador | terminado | detectar algo y no usarlo es pedirlo dos veces: `construccion/progreso/T055-registro.md` |
| T056 | El lugar se pregunta **una vez**, y los pasos van para atrás | RF1, GEO-01, I2, N02, GES-01 | T055 | A | orquestador | terminado | el lugar se preguntaba dos veces; commit `9308a36`, `16d88ef` |
| T057 | La consola muestra **lo que ya tenemos**, y se puede filtrar | GES-01..GES-04, CLA-02, BI-02 | T056 | A | orquestador | terminado | el departamento se capturaba y no se veía; commit `28ae6bf` |
| T058 | El aporte **se podía perder** antes de que el navegador hidratara | N02, I1, ADR 0012 | T057 | A | orquestador | terminado | la clave de envío iba vacía y el servidor lo rechazaba; commit `e41b842` |
| T059 | Estandarizar para **poder agrupar**: hace cuánto y a cuántos | NOR-01..NOR-04, I2, BI-02 | T057 | A | orquestador | terminado | «más de cuatro años» como rango, con su frase al lado; commit `a0d8be8` |
| T060 | La ubicación arriba, y **fuera los textos que nadie lee** | GES-02, CLA-02, N03, V14 | T057 | A | orquestador | terminado | un agente los auditó uno por uno; commit `67b88ca`, `c40421b` |
| T061 | La portada, **revisada en un teléfono de verdad** | RF10, M06, AGE-01 | T056 | A | orquestador | terminado | el botón quedaba bajo el pliegue en 360×560; commit `1280495`, `1f60df3` |
| T062 | La lista de temas pasa de **once a dieciocho** | CLA-01, Q32, N18 | T057 | A | orquestador | terminado | siete temas que no tenían a quién servir; commit `cbc1762`, `a6f3765` |
| T063 | Los recorridos **dejan de borrar** lo que alguien capturó a mano | AGENTS.md §12 | T062 | A | orquestador | terminado | proceso propio para la suite; comprobado con un aporte a mano; commit `8631b4e` |
| T064 | La portada toma la **línea gráfica** de la campaña | Q2, ADR 0006 | T061 | A | orquestador | terminado | paleta por tokens; 44 pares de contraste; commit `d963393` |
| T065 | **La identidad gráfica Patria Milagro, en el aplicativo entero** | interfaz.md I5, V22–V24, Q34 | T064 | A | orquestador | terminado | tokens en dos modos, 108 pares de contraste; 6 recorridos nuevos, uno visto fallar; portada, captura, seguimiento, encuentro, consola y administración |
| T066 | **Rediseño de la interfaz en dos rondas**: paleta oscura con hue, calendario de encuentros, consola con paginación y ficha en paneles | interfaz.md, V25, V26, AGE-01, GES-01..GES-04 | T065 | A | orquestador | terminado | el cliente veía «un póster azul»; 236 recorridos y 224 pruebas de nodo en verde, `paleta.test.ts` vista fallar: `construccion/progreso/T066-registro.md` |
...
| T031 | El corte exportable con su diccionario, filtros, zona horaria y versión de catálogo | RF6, TRA-01, R1, R2 | T022 | C | orquestador | terminado | 7 casos vistos fallar · **visto fallar otra vez** haciendo que recalculara en vez de leer la foto |
