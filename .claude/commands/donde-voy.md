---
description: Dónde vas, qué te bloquea y qué se está pudriendo. Empieza por aquí si no sabes qué sigue.
---

Vas a reportar el estado del descubrimiento. No escribes nada en disco: solo informas.
...
`mvp/src/producto/tokens.css` **declara variables, nunca reglas**. Una sola regla global
...
- Cualquier token sin origen: los que no salieron del cliente van marcados `DE REFERENCIA` o
  `PROVISIONAL`, y uno sin marca se lee como decidido cuando no lo está.
...
1. **Dónde vas** — la etapa, en una línea.
